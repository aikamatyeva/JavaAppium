...
public class WelcomePageObject extends MainPageObject {
    ...
    public void waitForLearnMoreLink() {
        this.waitForElementPresent(STEP_LEARN_MORE_ABOUT_LINK, "Cannot find Learn more about Wikipedia link", 10 );
    }
    ...
    public void waitForAddOrEditPreferredLangText() {
        this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFERRED_LANG_LINK, "Cannot find Add or edit preferred language text", 10 );
    }
