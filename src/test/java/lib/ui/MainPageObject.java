...
public class MainPageObject {
    ...
    public WebElement waitForElementАndClear(String locator, String error_message, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(locator, error_message, timeoutInSeconds);
        element.clear();
        return element;
    }
    ...
    public void swipeElementToLeft(String locator, String error_message) {
        if (driver instanceof AppiumDriver) {
            ...
            if (Platform.getInstance().isAndroid()) {
                ...
                int offset_x = (-2 * element.getSize().getWidth());
    ...
    private By getLocatorByString(String locator_with_type) {
        ...
        if(by_type.equals("xpath")) {
            ...
            throw new IllegalArgumentException("Cannot get type of the locator. Locator: " + locator_with_type);
        }
    }
}
